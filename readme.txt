...
curl -X GET http://127.0.0.1:8000/api/listes/2/ -H "Authorization: Token 953fdea292582301fff0245aa2ca229bbd9e26fe" -H "Content-Type: application/json"
...
curl -X DELETE http://127.0.0.1:8000/api/listes/1/ -H "Authorization: Token 41aff3bee92511db4eacce6a740b4dc286114ad8" -H "Content-Type: application/json"
...
curl -X GET http://127.0.0.1:8000/api/listes/2/followers/ -H "Authorization: Token 953fdea292582301fff0245aa2ca229bbd9e26fe" -H "Content-Type: application/json"

curl -X GET http://127.0.0.1:8000/api/listes/2/share-requests/ -H "Authorization: Token 953fdea292582301fff0245aa2ca229bbd9e26fe" -H "Content-Type: application/json"

GET | /api/listes/<token>/followers | Voir la liste des followers
GET | /api/listes/<token>/share-requests | Voir la liste des dmandes
