"""
Django settings for my_wishmas_list project.
...
SECRET_KEY = 'django-insecure-kqqx=qeszzxz#d)=gvnu20az@@zis36wdt!^7dhsevk-l8cd#q'
...
ROOT_URLCONF = 'my_wishmas_list.urls'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # utile pour l'interface web
    ],
